...
$pages = 9 + $i;
$url = 'https://www.flickr.com/services/rest/?method=flickr.photos.getRecent&api_key=928c834ae2e13e2e7006bd4f90e7bad3&page=' . $halaman . '&per_page=20&format=rest';


$url = file_get_contents($url);
$recent = simplexml_load_string($url);
...
<body>
    ...
    <div class="container">
        <h2 class="px-3 text-dark" style="padding-top: 80px;">Recent Photos</h2>
